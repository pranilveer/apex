...
const initialMessages: Message[] = [
  {
    id: "1", role: "ai", timestamp: "08:00 PM",
    content: `## Daily Analysis - ${today}

### What You Did Well
- Completed 10/13 daily tasks (77% completion rate)
- Maintained your LeetCode streak - 12 days strong!
- Put in solid 4 hours of coding practice
- Gym session completed despite a busy day

### What You Wasted Time On
- Social media: ~30 minutes (estimated)
- Context switching between projects: lost focus around 3 PM

### Improvements for Tomorrow
1. **Start with LeetCode** - Your problem-solving skills peak in the morning
2. **Block social media** during study hours (10 AM - 12 PM, 4 PM - 7 PM)
3. **Batch similar tasks** - Do all coding together, all reading together
4. **Add System Design** - You haven't practiced in 3 days

### Tomorrow's Schedule
| Time | Activity |
|------|----------|
| 6:00 AM | Wake up, hydrate |
| 6:30 AM | Gym (Push day) |
| 8:00 AM | LeetCode (2 problems) |
| 9:00 AM | Office work |
| 1:00 PM | Lunch + 10 min break |
| 2:00 PM | Office work |
| 5:30 PM | System Design (1 topic) |
| 6:30 PM | Personal Project (1 hr) |
| 7:30 PM | JavaScript/React study |
| 8:30 PM | Reading (30 min) |
| 9:00 PM | Journal + plan tomorrow |
| 11:00 PM | Wind down |
| 11:30 PM | Sleep`
  },
  {
    id: "2", role: "ai", timestamp: "08:01 PM",
    content: `### Suggested LeetCode Problems (Based on Weak Topics)

Your weakest areas are **Graphs** and **Dynamic Programming**. Here are problems to practice:

1. **Number of Islands** (Medium) - Graph/BFS - Great for building graph fundamentals
2. **Coin Change** (Medium) - DP - Classic DP pattern, frequently asked
3. **Course Schedule** (Medium) - Topological Sort - Important for interviews
4. **Word Break** (Medium) - DP + Trie - Common at FAANG companies

### System Design Topics for Tomorrow
- **Load Balancing** - You haven't covered this yet
- **Database Sharding** - Build on your DBMS knowledge
- **Rate Limiter Design** - Classic interview question`
  },
  {
    id: "3", role: "ai", timestamp: "08:02 PM",
    content: `### Interview Readiness Assessment

| Topic | Progress | Readiness |
|-------|----------|-----------|
| DSA | 65% | Medium - Focus on Graphs & DP |
| JavaScript | 75% | Good - Review Promise internals |
| React | 80% | Strong - Practice system design questions |
| Node.js | 55% | Needs work - Event-driven patterns |
| System Design | 30% | Weak - Priority topic |
| HR/Behavioral | 40% | Prepare STAR stories |

**Overall Readiness: 55%** - You need approximately 2-3 more months of focused preparation.
**Recommendation:** Prioritize System Design and DSA for the next 4 weeks.`
  },
]
